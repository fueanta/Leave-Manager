...
$(document).ready(function () {
    ...
    dataTable = $("#supervisor_inbox").DataTable({
        ...
        buttons: [
            ...
            { extend: 'print', text: '<i class="fas fa-print"></get_reclaims_for_supervisori> Print' },
        ...
        ajax: {
            url: "<?php echo URLROOT; ?>/index.php?url=api/get_reclaims_for_supervisor/<?php echo $data_array['id']; ?>",
            dataSrc: ""
        },
